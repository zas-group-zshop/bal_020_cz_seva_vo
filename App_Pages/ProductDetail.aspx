							...
							<div class="pageDesc page-description">
								...
								<div class="info">
								    ...
								    <div class="age <%= String.IsNullOrEmpty(EvalDataFromXml("kod_vyrobce").ToString()) ? "hide-control" : "" %>">
                                        <asp:Literal ID="lManufacturer" runat="server" Text="Věkové určení" />:
                                    ...
                                    <div class="col-lg-6">
                                        <table class="table-detail-info">
                                          <tr>
                                            ...
                                            <td class="right"><%= EvalDataFromXml("cislo_nomenklatury")%></td>
                                          </tr>
                                          <tr>
                                            <td class="left">EAN</td>
                                            <td class="right"><%= EvalDataFromXml("ean1")%></td>
                                          </tr>
                                          <tr>
                                            <td class="left">Hmotnost</td>
                                            <td class="right"><%= EvalDataFromXml("brutto")%> kg</td>
                                          </tr>
                                          <tr>
                                            <td class="left">Rozměry (Š x D x V)</td>
                                            <td class="right"><%= ZASutility.MyUtility.StringToInt((ZASutility.MyUtility.StringToNumeric(EvalDataFromXml("sirka"))/10).ToString()) %> x <%= ZASutility.MyUtility.StringToInt((ZASutility.MyUtility.StringToNumeric(EvalDataFromXml("delka"))/10).ToString()) %> x <%= ZASutility.MyUtility.StringToInt((ZASutility.MyUtility.StringToNumeric(EvalDataFromXml("vyska"))/10).ToString()) %> cm</td>
                                          </tr>
                                        </table>
                                    </div>
                                    <div class="col-lg-6">
                                        <table class="table-detail-info">
                                          <tr>
                                            ...
                                            <td class="right"><%= EvalDataFromXml("ean2_id_mj")%></td>
                                          </tr>
                                          <tr>
                                            <td class="left">EAN skupinového balení</td>
                                            <td class="right"><%= EvalDataFromXml("ean2")%></td>
                                          </tr>
                                          <tr>
                                            <td class="left">MO doporučená cena bez DPH</td>
                                            <td class="right"><%= GetFormatPrice(ZASutility.MyUtility.StringToNumeric(EvalDataFromXml("ref_cena")))%> <%= GetFormatCurrency(EvalDataFromXml("ref_cena_id_meny"))%></td>
                                          </tr>
                                        </table>
                                    </div>
                                </div>
			                ...
			                <div class="product-detail-box product-detail-cart">
								...
								<div class="productBox">
			                        ...
			                        <asp:Panel ID="pAddToBasket" runat="server" CssClass="addToBasket add-to-basket">
			                            ...
			                            <span class="product-detail-price text-center">
                                        										...
                                        										<span class="priceList price-with-vat">
                                        											<asp:PlaceHolder ID="phPriceWithDph" runat="server">
                                        				    							<span class="price"><%= GetFormatPrice(ZASutility.MyUtility.StringToNumeric(EvalDataFromXml("web_items_cena_bez_dph")))%></span>&nbsp;<span class="dph"><%= GetFormatCurrency(EvalDataFromXml("id_meny"))%></span>
                                        				                            </asp:PlaceHolder>
                                        										</span>
